...
<head>
	...
	<title>Ferreteria Rayito - Proveedores</title>
	...
	<header class="header_area">
		<div class="main_menu">
			<nav class="navbar navbar-expand-lg navbar-light">
				<div class="container">
					<a class="navbar-brand logo_h" href="productos"><img src="{{asset('template/img/Icon.png')}}" alt=""></a>
				...
				<div class="row no-gutters align-items-center pt-60px">
					<div class="col-5 d-none d-sm-block">
						<div class="hero-banner__img">
							<img class="img-fluid" src="template/img/ProveedorHome.jpg" alt="">
						</div>
					</div>
		...
		<section class="section-margin calc-60px">
			<div class="container">
				<div class="section-intro pb-60px">
					<h2>Lista de <span class="section-intro__style">Proveedores</span></h2>
				</div>
				<div class="row">
					{{$slot}}
				</div>
