...
<body>
    ...
    <div class="site-section">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="h3 mb-3 text-black"><br>Añade tu producto</h2>
                </div>
                <div class="col-md-7">
                    {{$slot}}
                </div>
                <div class="col-md-5 ml-auto">
                    ...
                    <div class="p-4 border mb-3">
                        ...
                        <p class="mb-0">Dato necesario y ademas debe ser numerico.</p>
                    </div>
                    <div class="p-4 border mb-3">
                        <span class="d-block text-primary h6 text-uppercase">Precio</span>
                        <p class="mb-0">Dato necesario y ademas debe ser numerico.</p>
                    </div>
                    <div class="p-4 border mb-3">
                    ...
                    <div class="p-4 border mb-3">
                        ...
                        <p class="mb-0">Dato necesario y ademas debe contener minimo 5 caracteres.</p>
                    </div>
