...
<head>
    <title>Ferreteria Rayito - Editar proveedor</title>
    <meta charset="utf-8">
...
<body>
    ...
    <header class="header_area">
        <div class="main_menu">
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container">
                    <a class="navbar-brand logo_h" href="producto"><img src="{{asset('template/img/Icon.png')}}" alt=""></a>
    ...
    <div class="site-section">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="h3 mb-3 text-black"><br>Editar datos del proveedor</h2>
                </div>
                <div class="col-md-7">
                    {{$slot}}
                </div>
